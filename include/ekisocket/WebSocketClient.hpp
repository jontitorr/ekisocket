...
public:
    ...
    /**
     * @brief Sets whether or not automatic reconnection should be enabled or not. If on, when disconnecting, the client will attempt to reconnect.
     *
    ...
    /**
     * @brief Closes the WebSocket connection, sending a close frame with a optional message stating the reason for the closure.
     *
